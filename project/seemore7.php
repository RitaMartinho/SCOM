...
<body>
    <?php
      ...
      foreach($lines as $hourminute){
        ...
        array_push($net_exp, array("experience"=>$firstelement[2],"netspeed"=>$firstelement[10]));
      }
    ...
    <div class="container">
        ...
        <div class="buttoncontainer">
          <button onclick="window.location.href='seemore6.php'">Previous</button>
          <button onclick="window.location.href='seemore8.php'" id= "button">Next</button>
        </div>
    </div>
    ...
    <script type="text/javascript"> //lost connections
        ...
        rawFile.open("GET", "txtfiles_todisplay/mediumload_by_exp.txt", false); // using synchronous call
        var allText;
        ...
        let massPopChart = new Chart(myChart, {
          ...
          options:{
            title:{
              display:true,
              text:'FEUP Eduroam - Page Load Time (in ms) vs User Experience',
              fontSize:30
            },
            legend:{
              display:true,
