...
<body>
    <?php
      ...
      foreach($lines as $hourminute){
        ...
        array_push($net_hour, array("hour"=>$hour_without_minute[0],"netspeed"=>$firstelement[10]));
      }
      ...
      $myfile = fopen('txtfiles_todisplay/mediumload_by_hour.txt', 'w+') or die("Unable to open file!");
      foreach($mediumbyhour as $item){
        fwrite($myfile, $item."\n");
      }

      $myfile1 = fopen('txtfiles_todisplay/maxload_by_hour.txt', 'w+') or die("Unable to open file!");
      foreach($maxbyhour as $item1){
        fwrite($myfile1,$item1."\n");
      }

      $myfile2 = fopen('txtfiles_todisplay/minload_by_hour.txt', 'w+') or die("Unable to open file!");
    ...
    <div class="container">
        ...
        <div class="buttoncontainer">
          <button onclick="window.location.href='seemore3.php'">Previous</button>
          <button onclick="window.location.href='seemore7.php'" id= "button">Next</button>
        </div>
    </div>
    ...
    <script type="text/javascript"> //lost connections
        ...
        rawFile.open("GET", "txtfiles_todisplay/mediumload_by_hour.txt", false); // using synchronous call
        var allText;
        ...
        rawFile1.open("GET", "txtfiles_todisplay/maxload_by_hour.txt", false); // using synchronous call
        var allText1;
        //alert("Starting to read text");
        ...
        rawFile2.open("GET", "txtfiles_todisplay/minload_by_hour.txt", false); // using synchronous call
        var allText2;
        //alert("Starting to read text");
        ...
        let massPopChart = new Chart(myChart, {
          ...
          data:{
            ...
            datasets:[
            {
              ...
              backgroundColor:'rgba(72, 99, 255, 0.1)',
              borderWidth:1,
              borderColor:'#777',
              hoverBorderWidth:3,
            ...
            },
            {
              ...
              backgroundColor:'rgba(76, 76, 157, 0)',
              borderWidth:2,
              borderColor:'#4C4C9D',
              hoverBorderWidth:3,
              hoverBorderColor:'#000',
          ...
          options:{
            title:{
              display:true,
              text:'FEUP Eduroam - Page Load Time (in ms) per hour',
              fontSize:30
            },
            legend:{
              display:true,
