...
<body>
    <?php
      ...
      foreach($lines as $hourminute){
        ...
        array_push($net_hour, array("hour"=>$hour_without_minute[0],"netspeed"=>$firstelement[11]));
      }
      ...
      $myfile = fopen('txtfiles_todisplay/mediumlatency_by_hour.txt', 'w+') or die("Unable to open file!");
      foreach($mediumbyhour as $item){
        fwrite($myfile, $item."\n");
      }

      $myfile1 = fopen('txtfiles_todisplay/maxlatency_by_hour.txt', 'w+') or die("Unable to open file!");
      foreach($maxbyhour as $item1){
        fwrite($myfile1,$item1."\n");
      }

      $myfile2 = fopen('txtfiles_todisplay/minlatency_by_hour.txt', 'w+') or die("Unable to open file!");
    ...
    <div class="container">
        ...
        <div class="buttoncontainer">
          <button onclick="window.location.href='seemore8.php'">Previous</button>
          <button onclick="window.location.href='seemore10.php'" id= "button">Next</button>
        </div>
    </div>
    ...
    <script type="text/javascript"> //lost connections
        ...
        rawFile.open("GET", "txtfiles_todisplay/mediumlatency_by_hour.txt", false); // using synchronous call
        var allText;
        ...
        rawFile1.open("GET", "txtfiles_todisplay/maxlatency_by_hour.txt", false); // using synchronous call
        var allText1;
        //alert("Starting to read text");
        ...
        rawFile2.open("GET", "txtfiles_todisplay/minlatency_by_hour.txt", false); // using synchronous call
        var allText2;
        //alert("Starting to read text");
        ...
        let massPopChart = new Chart(myChart, {
          ...
          options:{
            title:{
              display:true,
              text:'FEUP Eduroam - Latency (in ms) per hour',
              fontSize:30
            },
            legend:{
              display:true,
